...
public static class OptionsExtensions
{
    ...
    /// <param name="builder">The <see cref="IHostApplicationBuilder"/> instance used to build the web application.</param>
    ...
    /// </remarks>
    public static T GetCustomOptionsConfiguration<T>(this IHostApplicationBuilder builder, string configurationSectionName) where T : class, ICustomOptions, new()
    {
